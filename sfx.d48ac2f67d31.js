...
(()=>{
  ...
  const battleAudio=new Audio('assets/battle-start-edge-v2.mp3');battleAudio.preload='auto';
  ...
  const durations={ultimateCutin:.72,waterStart:.18,waterSwing:.24,continentStart:.23,continentSwing:.34,hit:.12,down:.43,shot:.28,hurt:.20,battleStart:1.85,superdash:.48,guardRaise:.18,guardBlock:.24};
