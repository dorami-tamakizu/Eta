...
function end(ok){
  ...
  $('#resultText').innerHTML=
    ...
    resultRow('総被ダメージスコア','総被ダメージ',S.dmg.toLocaleString('ja-JP'),points.damage)+
    resultRow('与ダメージスコア','総与ダメージ',(S.dealtDamage+S.overkill).toLocaleString('ja-JP'),points.dealt+points.overkill);
