...
(()=>{
  ...
  const battleAudio=new Audio('assets/ultimate-cutin-original-v5.m4a');battleAudio.preload='auto';
  ...
  const durations={ultimateCutin:.72,waterStart:.18,waterSwing:.24,continentStart:.23,continentSwing:.34,hit:.12,down:.43,shot:.28,hurt:.20,battleStart:.72,superdash:.48,guardRaise:.18,guardBlock:.24};
