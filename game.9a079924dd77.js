...
function bossVisual(e){
  ...
  // Supplied atlas: 1–4 vertical, 5–8 horizontal. Frame 3/7 is contact.
  const base=a.kind==='dragon'?0:4;
  const times=[0,a.impact-.20,a.impact,a.impact+.16];
...
function drawBossFrame(sheet,frame,h,alpha=1){
  ...
  const baseline=sheet===im.bossSkills?[500,503,503,503,497,490,480,480][frame]:ch;
  const dy=-h*baseline/ch;
  c.save();c.globalAlpha*=alpha;
  c.drawImage(sheet,sx,sy,cw,ch,-w/2,dy,w,h);
  c.restore();
}
