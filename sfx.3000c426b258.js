...
(()=>{
  ...
  const battleAudio=new Audio('assets/cutin-clean-v6.m4a');battleAudio.preload='auto';battleAudio.volume=.12;
  const ultimateAudio=new Audio('assets/cutin-clean-v6.m4a');ultimateAudio.preload='auto';let resumeUltimate=false;
